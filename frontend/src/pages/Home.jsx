            ...
            <div className="lg:w-[570px]">
              ...
              <div className="mt-8 flex flex-col lg:flex-row lg:items-center gap-5 lg:gap-10">
                <div className="text-center">
                  <h2 className="text-[36px] lg:text-[44px] font-[700] text-headingColor">20+</h2>
                ...
                <div className="text-center">
                  <h2 className="text-[36px] lg:text-[44px] font-[700] text-headingColor">10+</h2>
        ...
        <div className="container mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 lg:gap-10 mt-10">
            ...
            {[{
              icon: icon01,
              title: "Find A Doctor",
              desc: "Easily search and connect with experienced doctors for your healthcare needs.",
              link: "/doctors"
            },{
              icon: icon02,
              ...
              desc: "Schedule appointments with our expert doctors at your convenience.",
              link: "/doctors"
            }].map((service, index) => (
              <div key={index} className="py-8 px-5 text-center border rounded-lg shadow-sm hover:shadow-md transition-all">
                <img src={service.icon} alt={service.title} className="mx-auto" />
                <h3 className="text-[26px] font-[700] text-headingColor mt-6">{service.title}</h3>
                <p className="text-textColor mt-4">{service.desc}</p>
                <Link to={service.link} className="inline-flex items-center justify-center mt-6 w-12 h-12 mx-auto rounded-full border border-[#181A1E] hover:bg-primaryColor hover:border-none">
        ...
        <div className="container mx-auto">
          <div className="flex flex-col md:flex-row items-center gap-8 lg:gap-16">
            ...
            <div className="w-full md:w-1/2">
              <h2 className="heading mb-6">Most Questions By Our Beloved Patients</h2>
              <FaqList />
            </div>
