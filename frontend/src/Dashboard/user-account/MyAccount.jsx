          ...
          <div className="pb-[50px] px-[30px] rounded-md">
            <div className="flex items-center justify-center">
              <figure className="w-[100px] h-[100px] rounded-full border-solid border-primaryColor">
                <img src={userData.photo} alt="" className='w-full h-full rounded-full mt-5' />
              </figure>
            </div>
            ...
            <div className="mt-[50px] md:mt-[100px]">
              ...
              <button className="w-full bg-red-800 mt-4 p-3 text-[16px] leading-7 rounded-md text-white">Delete account</button>
            </div>
